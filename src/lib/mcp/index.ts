...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Tools for LiveNotebook — a teacher CRM. List and update your own students, lessons, homework, and payments. All calls are scoped to the signed-in user via Supabase RLS.",
