    ...
    <div className="pointer-events-none fixed inset-0 z-50 flex items-end justify-center sm:items-center">
      <div
        ...
        className={`absolute inset-0 bg-black/30 transition-all duration-300 ease-out ${
          visible ? "pointer-events-auto opacity-100 backdrop-blur-xl saturate-150" : "pointer-events-none opacity-0 backdrop-blur-0"
        }`}
      />
      <div
        className={`glass-strong relative z-10 w-full max-w-md rounded-t-[28px] p-5 sm:rounded-[28px] [--safe-bottom-offset:1.25rem] safe-bottom
          ...
          ${visible ? "pointer-events-auto translate-y-0 scale-100 opacity-100" : "pointer-events-none translate-y-8 scale-[0.985] opacity-0"}`}
      >
