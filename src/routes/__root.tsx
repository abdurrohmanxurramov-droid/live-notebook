...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Премиум CRM для преподавателей: ученики, посещаемость, финансы.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/9e453c54-d505-43c4-8639-cf21b0fc3cd9/id-preview-81f0475e--d39d2996-2034-45a2-9d70-95ccd7843397.lovable.app-1780566296895.png",
      },
      {
        name: "twitter:image",
        content:
