  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-8">
      <header className="mb-6">
        ...
        <h1 className="mt-1 text-2xl font-semibold text-foreground">Доверие и безопасность</h1>
      ...
      <div className="space-y-4">
        ...
        <Section title="Хранение данных и инфраструктура">
          ...
          <p>
            Резервные копии данных пользователь может выгрузить из раздела «Настройки → Резервная
            копия» в собственном аккаунте в любое время.
          </p>
        </Section>
        ...
        <Section title="Шифрование передачи">
          <p>
            ...
            HTTPS/TLS. Cекреты (ключи API, токены) хранятся как переменные окружения серверной среды
            и недоступны клиентскому коду.
          </p>
        </Section>
        ...
        <Section title="Сторонние сервисы">
          ...
          <p>
            Эти сервисы получают только данные, необходимые для выполнения их функции (например,
            идентификатор подписки на push). Аналитика и реклама третьих сторон в приложении не
            подключены.
          </p>
        </Section>
        ...
        <Section title="Push-уведомления">
          <p>
            Push-уведомления отправляются только на устройства, которые пользователь явно подписал.
            Подписку можно отключить в настройках устройства или в разделе настроек приложения;
            запись подписки при этом удаляется.
          </p>
        </Section>
        ...
        <Section title="Удаление и экспорт данных">
          ...
          <p>
            Для полного удаления аккаунта и связанных данных напишите на адрес ниже — запрос будет
            обработан вручную.
          </p>
        </Section>
        ...
        <Section title="Сообщения об уязвимостях">
          <p>
            ...
            публикуйте подробности до устранения и свяжитесь с нами по email ниже. Мы постараемся
        ...
        <Section title="О чём эта страница не говорит">
          <p>
            ...
            соответствии GDPR. Указанные выше меры — это текущие практики продукта, а не гарантии
